...
# Explicit rule for console_handler to ensure it's built
$(OBJ_DIR)/console_handler.o: $(SRC_DIR)/app/console_handler.cpp $(SRC_DIR)/app/console_handler.h $(SRC_DIR)/logger/logger.h
	@mkdir -p $(dir $@)
	$(CXX) $(CXXFLAGS) -c $< -o $@
